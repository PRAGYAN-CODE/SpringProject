...
import com.pra.service.ProjectMgmtService;

@SpringBootApplication
public class SpringBootWithHibernetApplication {
	...
	public static void main(String[] args) {
		...
		ProjectMgmtService service=null;
		 ProjectDTO dto=null;
		//get IOC container
		ctx=SpringApplication.run(SpringBootWithHibernetApplication.class, args);
